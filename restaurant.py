...
lblInfo = Label(Tops, font=('arial', 30, 'bold'), text="APNA RESTAURANT ", fg="Steel Blue", bd=10, anchor='w')
...
txtIdly = Entry(f1, font=('arial', 16, 'bold'), textvariable=Idly, bd=10, insertwidth=4, bg="powder blue",
                justify='right')
txtIdly.grid(row=1, column=1)

lblDosa = Label(f1, font=('arial', 16, 'bold'), text="Dosa", bd=16, anchor="w")
lblDosa.grid(row=2, column=0)
txtDosa = Entry(f1, font=('arial', 16, 'bold'), textvariable=Dosa, bd=10, insertwidth=4, bg="powder blue",
                justify='right')
txtDosa.grid(row=2, column=1)

lblKesari = Label(f1, font=('arial', 16, 'bold'), text="Biryani", bd=16, anchor="w")
lblKesari.grid(row=3, column=0)
txtKesari = Entry(f1, font=('arial', 16, 'bold'), textvariable=Kesari, bd=10, insertwidth=4, bg="powder blue",
                  justify='right')
txtKesari.grid(row=3, column=1)

lblPulav = Label(f1, font=('arial', 16, 'bold'), text="Lacha Paratha", bd=16, anchor="w")
lblPulav.grid(row=4, column=0)
txtPulav = Entry(f1, font=('arial', 16, 'bold'), textvariable=Pulav, bd=10, insertwidth=4, bg="powder blue",
                 justify='right')
txtPulav.grid(row=4, column=1)

lblKarabath = Label(f1, font=('arial', 16, 'bold'), text="Sahi Paneer", bd=16, anchor="w")
lblKarabath.grid(row=5, column=0)
txtKarabath = Entry(f1, font=('arial', 16, 'bold'), textvariable=Karabath, bd=10, insertwidth=4, bg="powder blue",
                    justify='right')
